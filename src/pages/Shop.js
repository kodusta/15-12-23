                                    ...
                                    <div className="col-12 col-md-8 col-lg-9">
                                        ...
                                        <div className="row align-items-center justify-content-between">
                                            <div className="col-auto">
                                                <span className="goods-filter-btn-open js-toggle-filter"><i
                                                    className="fontello-filter"/>Filter</span>
                                            </div>
                                            <div className="col-auto">
                                            ...
                                            <div className="__inner">
                                                <div className="row">
                                                    ...
                                                    {this.props.products.map(product => (
                                                        <ProductCard key={product.id} product={product} getCategoryName={this.props.getCategoryName}/>
                                                    ))}
